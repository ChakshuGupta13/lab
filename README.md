...
| [pqc-fault-sat](cryptanalysis/pqc-fault-sat/) | Rank ceiling for twiddle-perturbation faults on the forward NTT of ML-KEM and ML-DSA (Lean 4 formalisation + Python reference) |
